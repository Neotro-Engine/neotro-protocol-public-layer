# Data Non-Retention Notice v1.4

## 1. Core Principle

Neotro Protocol Project does not require ownership, retention, or unrestricted processing of customer raw data.

Any customer data access must be separately authorized, purpose-limited, and contract-bound.

## 2. Neotro Protocol Project Does Not Require

By default, Neotro Protocol Project does not require access to or retention of:

- customer raw data  
- original operating logs  
- personally identifiable information  
- internal system source material  
- private source code  
- full telemetry payloads  
- customer trade secrets  
- unrestricted historical datasets

## 3. Default Materials

By default, Neotro Protocol Project works with:
...
- no-content license telemetry

## 4. Contract-Bound Data Access

If customer data access is required for Internal PoC, Commercial Integration, or Certified / Calibration use, the following must be defined in a separate agreement:
...
- deletion condition  
- reuse prohibition  
- model-training reuse prohibition  
- third-party transfer prohibition  
- access control terms

## 5. No-Content Usage Signal

License Telemetry or Hash-based Usage Proof may be used to verify that Neotro Protocol was used without transmitting raw customer data.
