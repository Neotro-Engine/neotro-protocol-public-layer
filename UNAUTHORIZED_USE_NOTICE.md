# Unauthorized Use Notice v1.4

## 1. Purpose

This public notice defines the general boundary for unauthorized or out-of-scope use of Neotro Protocol.

Detailed response procedures are not disclosed in the Public Layer and are managed internally by Neotro / Neotro Protocol Project.

## 2. Public Notice

Unauthorized or out-of-scope use of Neotro Protocol may require scope review, license review, access restriction, certification revocation, or legal review depending on the nature and severity of the use. Detailed response procedures are managed internally by Neotro / Neotro Protocol Project.

## 3. Public Boundary

This public notice does not grant commercial authorization, certified status, domain calibration rights, third-party sublicensing rights, resale rights, or access to internal response procedures.
