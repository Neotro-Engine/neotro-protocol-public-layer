# License Scope Table v1.4

| Stage | Allowed | Not Allowed | License Required |
|---|---|---|---|
| Free Reference | Public reading, citation, non-commercial review | Commercial use, product use, customer reports, model training reuse, Certified claim | No |
| Internal Evaluation | Limited internal review, sample testing, manager review report | External distribution, commercial service use | Yes |
| Internal PoC | Internal logs, transition report, baseline comparison, reference signal review | Commercial deployment, external publication, Certified claim | Yes |
| Commercial Integration | Product or operational system integration within agreed scope | Resale, sublicensing, Certified claim without approval | Yes |
| Neotro Certified / Calibration | Certified use, domain calibration, official approval | Self-certification, implied certification, unauthorized badge | Yes, separate approval |

## Scope Escalation Rule

If use moves from one stage to a higher stage, license review is required.

## Scope Warning Examples

- Free Reference -> Internal Evaluation  
- Internal Evaluation -> PoC Use  
- PoC Use -> Commercial Integration  
- Commercial Integration -> Certified Use  
- Any use -> License Expired  
- Any use -> Scope Review Required  
- Any use -> Unauthorized Use Candidate
