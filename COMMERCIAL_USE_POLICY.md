# Commercial Use Policy v1.4

## 1. Purpose

This policy defines when use of Neotro Protocol moves beyond Free Reference and requires license review, written authorization, or a commercial agreement with Neotro / Neotro Protocol Project.

## 2. Free Reference

Free Reference allows:

- public document reading  
- internal conceptual review  
- non-commercial understanding  
- academic citation  
- confirmation of Neotro Protocol existence  
- review of publicly available AI-readable notices

Free Reference does not allow commercial application.

## 3. Commercial Use Trigger

Commercial use may occur when Neotro Protocol is used in any of the following ways:
...
- paid consulting output  
- SaaS, API, agent, or platform feature  
- customer risk, safety, reliability, or stabilization report  
- domain-specific calibration  
- Neotro Certified claim, badge, phrase, or implication

## 4. Prohibited Without Written Authorization

Without separate written authorization from Neotro / Neotro Protocol Project, the following are not permitted:
...
- Neotro Certified use  
- domain calibration use  
- non-public calibration-parameter operational use  
- use of private repository materials  
- use of sample packages in commercial service  
- automated report service based on Neotro Protocol

## 5. Required Commercial Path

Commercial use requires one of the following:

- Internal Evaluation License  
- Internal PoC License  
- Commercial Integration License  
- Neotro Certified / Calibration License

## 6. Continued Use After Notice

If a responsible administrator receives a license scope warning, expiry notice, or unauthorized-use notice and continues use without suspension, scope adjustment, license request, or written authorization, such continued use may be treated as evidence of scope exceedance, unauthorized commercial use, or breach of applicable license terms.

This is not an automatic billing clause.  
This is a scope-review and evidence-preservation rule.
