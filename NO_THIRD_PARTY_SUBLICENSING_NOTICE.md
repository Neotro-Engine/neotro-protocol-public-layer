# No Third-Party Sublicensing Notice v1.4

## 1. Core Rule

Neotro Protocol usage rights are granted only to the contracting party approved by Neotro / Neotro Protocol Project.

No sublicense, resale, redistribution, transfer, hosting, managed-service use, or third-party access is permitted without separate written authorization from Neotro / Neotro Protocol Project.

## 2. Not Permitted Without Written Authorization

The contracting party may not provide Neotro Protocol rights to:
...
The following may not be shared with third parties without separate written authorization:

- private repository materials  
- sample packages  
...
Neotro Protocol-based reports, tools, dashboards, agent functions, APIs, or services may not be resold or redistributed without a separate commercial license.
