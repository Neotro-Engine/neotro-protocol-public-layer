...
## 2. What Neotro Protocol Does Not Do

Neotro Protocol does not perform:

- automatic shutdown  
- automatic blocking  
- automatic sending  
- automatic deployment  
- automatic braking, steering, or acceleration  
- automatic routing change  
- automatic charging stop or derating  
- automatic medical diagnosis  
- automatic legal judgment  
- automatic financial decision  
- automatic safety-critical final decision

## 3. Human Review Boundary

All outputs are limited to human-review reference signals.

Final decisions remain with:

- existing operators  
- existing safety stack  
- existing responsibility lines  
- human administrators  
- authorized domain experts  
- the customer's existing governance process

## 4. High-Risk Domain Notice

Medical, autonomous, legal, financial, safety-critical, and high-risk operational domains require separate review.

Neotro Protocol must not be interpreted as a substitute for domain authority, safety certification, medical judgment, legal judgment, financial authorization, or autonomous control approval.
